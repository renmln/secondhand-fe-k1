            ...
            <div>
                ...
                <div className="row">
                    {user === null ? (
                        ...
                        <>
                            <div className="col-xl-1 col-sm-1 col-1 d-flex" style={{width: "70px"}}>
                                <img src={user.photo_profile} alt="" className="img-fluid align-items-center" style={{width: "70px", objectFit: "contain"}} />
                            </div>
                    ...
                    <div className="col-9 ">
                        <div className="row justify-content-center">
                            <div
                                ...
                                style={{border: "2px dashed", color: "#D0D0D0", height: "400px", boxShadow: "0px 0px 4px rgba(0, 0, 0, 0.15)", borderRadius: "4px"}}
                            >
                            ...
                            {product.length === 0 ? (
                                ...
                                product.map((item) => (
                                    <div key={item.id} className="col-xl-3 col-md-5 col-sm-12 m-2" style={{border: "1px solid rgba(0,0,0,.125)"}}>
                                        <a href="/halamanproduk" className="text-decoration-none" style={{color: "black"}}>
                                            <div className="card " style={{border: "none", boxShadow: "0px 0px 4px rgba(0, 0, 0, 0.15)", padding: "8px, 8px, 16px, 8px", borderRadius: "4px"}}>
                                                <div className="d-flex justify-content-center">
                                                    <img className="card-img-top center-cropped m-1 img-fluid" style={{height: "250px", objectFit: "cover"}} src={item.image_1} alt="test" />
                                                </div>
